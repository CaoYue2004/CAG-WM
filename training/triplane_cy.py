...
from training.volumetric_rendering.ray_sampler_cy import RaySampler
import dnnlib
...
class TriPlaneGenerator(torch.nn.Module):
    ...
    def synthesis(self, ws, c, delta_y, delta_z, neural_rendering_resolution=None, update_emas=False,
