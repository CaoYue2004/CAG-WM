...
class RaySampler(torch.nn.Module):
    ...
    def forward(self, cam2world_matrix, intrinsics, resolution, delta_y, delta_z):
        """
        ...
        # ray_origins -= torch.tensor([0, delta_y, delta_z], device=cam2world_matrix.device).unsqueeze(0).unsqueeze(1)
