...
class TriPlaneGenerator(torch.nn.Module):
    ...
    def synthesis_planes(self, ws, c, neural_rendering_resolution=None, update_emas=False, cache_backbone=False,
    ...
    def synthesis_imgs(self, planes, ws, c, neural_rendering_resolution=None, update_emas=False, cache_backbone=False, use_cached_backbone=False, **synthesis_kwargs):
        cam2world_matrix = c[:, :16].view(-1, 4, 4)
        intrinsics = c[:, 16:25].view(-1, 3, 3)
        print(f'cam2world_matrix={cam2world_matrix}, intrinsics={intrinsics}')
