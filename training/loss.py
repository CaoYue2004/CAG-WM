...
class StyleGAN2Loss(Loss):
    ...
    def run_D(self, img, c, blur_sigma=0, blur_sigma_raw=0, update_emas=False):
        ...
        # print(f'image.shape={img["image"].shape}')    [B C 512 512]
        # print(f'image_raw.shape={img["image_raw"].shape}')    [B C neural_rendering_resolution neural_rendering_resolution]
    ...
    def accumulate_gradients(self, phase, real_img, real_c, gen_z, gen_c, gain, cur_nimg):
        ...
        # print(f'real_image.shape = {real_img.shape}') [B, C, 512, 512]
        # print(f'real_img_raw.shape = {real_img_raw.shape}')   [B, C, neural_rendering_resolution, neural_rendering_resolution]
